...
The sample with number 0 is a keyframe. Since there is no previous packet to calculate the delta, the difference method and ZigZag are skipped. Data is processed directly by FLAG, HUF, FLAG+HUF, or ANS methods. A keyframe occurs automatically every 8 packets or after device reset.
